...
COPY connexions(duration, protocol_type, service, flag, src_bytes, dst_bytes, land, wrong_fragment, urgent, hot, 
...
FROM '/docker-entrypoint-initdb.d/data/KDDCup99.csv'
